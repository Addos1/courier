...
<div class="admintitle">
    ...
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b;">Поиск информации о данных</h1>
</div>
...
<table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 5px;">
    ...
    if(mysqli_num_rows($run)<1){
        echo "<tr><td colspan='6'>Запись не найдена..</td></tr>";
    }
    else{
        $count=0;
        ...
        <tr align="center">
            ...
            <td><a href="datadeleted.php?bb=<?php echo $data['billno']; ?>">Удалить</a></td>
        </tr>
        <?php
        }
    }
